...
class AbstractAED(AbstractActiveFeatureAcquisitionStrategy):
    ...
    def __init__(self, target_col_name, budget_manager, categories=None, acquisition_costs={}, debug=True):
        """
...
class MultiWindowAED(AbstractAED):
    ...
    # 
    def __init__(self, ild, window_size, target_col_name, budget_manager, categories=None, acquisition_costs={}, debug=True):
        """
        Active Feature Acquisition strategy that ranks features accoring to average euclidean distance
        Requires the exact categories and possible category values beforehand
...
class SingleWindowAED(AbstractAED):
    def __init__(self, window, target_col_name, budget_manager, categories=None, acquisition_costs={}, debug=True):
        """
        Active Feature Acquisition strategy that ranks features accoring to average euclidean distance
        Requires the exact categories and possible category values beforehand
